                    ...
                    <div className="col-md-6">
                        <div className="mb-3 formGroup">
                            ...
                            <select className="form-select">
                                ...
                                <option value="+55"> British Virgin Islands (+55) </option>
                                ...
                                <option value="+1-784"> Saint Vicent and the Grenadines (+1-784) </option>
                                <option value="+685"> Samoa (+685) </option>
                                <option value="+378"> San Marino (+378) </option>
                                <option value="+239"> Sao Tom? and Pr?ncipe (+239) </option>
