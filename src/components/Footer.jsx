        ...
        <div className="container-fluid bg-dark text-white">
          <div className="row ">
            ...
            <div className="col-md-3 py-3">
              ...
              <hr />
              <address>
                <strong>Dubai Private Tour / Milan Tours & Tour Guide Services LLC.</strong>
                <br />
                Office 117, Al Makhawi Building
                <br />
                Al Karama, Dubai, UAE, P.O.Box: 120730
                <br />
                <abbr title="Phone">P:</abbr> +971 55 955 4333
              </address>
              <div className="h6">Customer Care</div>
              <hr />
              <IconTelephone /> +971 55 955 4333
              <br />
              <IconEnvelope /> info@dubaiprivatetour.com
            </div>
          </div>
        </div>
        <div className="container-fluid bg-secondary text-white text-center">
          <div className="row">
            ...
            <div className="col-md-3 py-2">
              © 2023 -{new Date().getFullYear()} Dubai Private Tour
            </div>
